      ...
      if (bpr[0].status_core == "1") {
        ...
        if (!Auth.length) {
          ...
          if (trx_type === "TRX") {
            ...
            const data = { no_hp: Auth[0].no_hp, bpr_id: Auth[0].bpr_id, no_rek, amount, trans_fee, pin: mpin, trx_code, trx_type, keterangan, acq_id: "", terminal_id: "", token: "", lokasi: "", tgl_trans: moment().format('YYYY-MM-DD HH:mm:ss'), tgl_transmis, rrn }
            console.log("data");
            console.log(data);
